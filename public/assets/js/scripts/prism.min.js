/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+basic+c+csharp+cpp+clojure+diff+elixir+elm+erlang+go+graphql+haskell+java+json+less+lisp+lua+makefile+markdown+markup-templating+pascal+perl+php+python+r+ruby+rust+sass+scss+shell-session+sql+swift+typescript+vbnet+yaml&plugins=autolinker+highlight-keywords+keep-markup+toolbar+copy-to-clipboard */
